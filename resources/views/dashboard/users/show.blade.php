        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">{{__('user.show')}}</h3>
                </div>
                <!--begin::Form-->
...
{{--                                        <input type="hidden" name="profile_avatar_remove"/>--}}
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="name"
                                       placeholder="{{__('user.username')}}" disabled value="{{$user->name}}"/>
                                @error('name')
                                <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="email" class="form-control" name="email"
                                       placeholder="{{__('user.email')}}" disabled value="{{$user->email}}"/>
                                @error('email')
                                <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-lg-6">
{{--                                <button type="submit" class="btn btn-primary mr-2">{{__('aside.save')}}</button>--}}
